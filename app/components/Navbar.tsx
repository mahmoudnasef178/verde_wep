          ...
          <div className={styles.rightSection}>
            ...
            <div className={styles.icons}>
                    ...
                    {userMenuOpen && (
                      <div className={styles.userDropdown}>
                        ...
                        <div className={styles.userDropdownItems}>
                          ...
                          <Link href="/favorites" onClick={() => setUserMenuOpen(false)} className={styles.userDropdownItem}>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <Link
                ...
                id="nav-fav-btn"
              >
                <svg width="19" height="19" viewBox="0 0 24 24" fill={favorites.length > 0 ? '#e05c5c' : 'none'} stroke={favorites.length > 0 ? '#e05c5c' : 'currentColor'} strokeWidth="1.5">
                  <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l8.72-8.72 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                </svg>
      ...
      <div className={`${styles.mobileMenu} ${menuOpen ? styles.mobileMenuOpen : ''}`}>
        <div className={styles.mobileInner}>
          ...
          <nav className={styles.mobileNav}>
            ...
            <Link href="/favorites" className={styles.mobileLink} onClick={() => setMenuOpen(false)}>
